...
RSpec.describe Counters::UniqueVisits do
  ...
  describe '.call' do
    ...
    context 'when multiple addresses' do
      ...
      it { is_expected.to eq [EndpointVisits.new('/some/endpoint', 2)] }
    end
    ...
    context 'when multiple endpoints' do
      ...
      it { is_expected.to eq [EndpointVisits.new('/some/endpoint', 1), EndpointVisits.new('some/other/endpoint', 1)] }
    end
  end
end
